...
const translations = {
  ...
  en: {
    ...
    coachTitle2: "AI Coach.",
    coachDesc: "Meet your AI Coach. With their motivation, they will give you tips like:",
    ...
    coachMsgAi: "Let's do this! I am here to help you with tips and workouts. Let's go all in!",
    ...
    proCoachDesc: "Enjoy the best AI Coach to guide you toward your goals.",
